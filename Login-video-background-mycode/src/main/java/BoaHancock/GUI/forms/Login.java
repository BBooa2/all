...
public class Login extends JPanel {
    ...
    public LoginRequestInfo info;
    private final JTextField2 txtUsername = new JTextField2();
    ...
    private void init() {
        ...
        cmdLogin.addActionListener(e -> {
            info = new LoginRequestInfo(txtUsername.getText(), new String(txtPassword.getPassword()));
            Main.client.sendLoginMessage(info);
        });
